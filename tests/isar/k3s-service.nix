...
#
# Usage:
#   nix build '.#checks.x86_64-linux.isar-k3s-service'
#
# =============================================================================
...
let
  ...
  test = mkISARTest {
    ...
    testScript = ''
      ...
      log_section("NETWORK", "Adding default route for k3s")
      ...
      server.succeed("ip route add default via 192.168.1.254 dev eth1 || true")
