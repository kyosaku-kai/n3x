# SWUpdate module - connects bundle generation with isar-artifacts
#
# This module provides per-machine SWUpdate bundle derivations using
# artifacts from isar-artifacts.nix and versions from versions.nix.
#
# Usage:
#   let
...
let
  ...
  versions = isarArtifacts.versions;
  ...
  mkMachineBundle = { targetMachine, role }:
    mkBundle {
      inherit pkgs lib isarArtifacts targetMachine role;
