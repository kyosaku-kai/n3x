...

{
  ...
  networking = {
    ...
    # This node will use:
    # - Bond IP: 10.10.10.15 (K3s)
    # - VLAN 100: 10.10.100.15 (Storage)
  };
  ...
  # Resource limits for k3s on constrained Jetson hardware (8GB total RAM)
  # Override the default 8G limit from k3s-server.nix to leave headroom for system
  systemd.services.k3s.serviceConfig.MemoryMax = lib.mkForce "6G";
