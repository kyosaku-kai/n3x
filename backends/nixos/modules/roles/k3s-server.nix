...

{
  ...
  systemd.services.k3s = {
    ...
    serviceConfig = {
      ...
      # Use lib.mkDefault to allow per-host overrides (e.g., Jetson with 8GB total RAM)
      CPUWeight = lib.mkDefault 200; # Higher priority
      MemoryMax = lib.mkDefault "8G"; # Limit memory usage
      MemorySwapMax = lib.mkDefault "2G"; # Limit swap usage
    };
