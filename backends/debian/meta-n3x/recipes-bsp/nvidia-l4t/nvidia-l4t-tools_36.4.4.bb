...
#   rg -n "L4T_VERSION|36\.4\.4" meta-n3x/recipes-bsp/nvidia-l4t/
# Update both nvidia-l4t-core and nvidia-l4t-tools recipes when upgrading.
PV = "36.4.4-20250616085344"

SRC_URI = "${NVIDIA_L4T_MIRROR}/t234/pool/main/n/nvidia-l4t-tools/nvidia-l4t-tools_${PV}_arm64.deb"
